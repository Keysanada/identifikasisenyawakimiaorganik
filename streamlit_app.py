...
st.title("🔬 Identifikasi Senyawa Organik Berdasarkan Uji Warna")
...
# === CABANG NON-KARBOHIDRAT: PROTEIN & ALKOHOL & LAINNYA ===
    ...
    st.info("Molisch negatif → kemungkinan **bukan karbohidrat**.")
    ...
    if ninhidrin == "Positif (biru)":
        ...
        if ceric == "Positif (merah ceri atau cokelat)":
            ...
            else:  # NaHSO₃ negatif → lanjut ke hidrokarbon/aromatik
...
st.markdown("---")
st.caption("Kelompok 4 • Streamlit untuk Identifikasi Senyawa Organik")
